...
const PrivacyPage = () => {
  ...
  const sections = [
    ...
    {
      title: 'اتصل بنا',
      content: 'إذا كان لديك أي استفسار حول سياسة الخصوصية هذه أو ممارسات الخصوصية لدينا، فلا تتردد في التواصل معنا عبر البريد الإلكتروني: elhfnaweedowidar456@gmail.com أو من خلال نموذج التواصل في المنصة.',
    },
  ];
