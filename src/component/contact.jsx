...
function ContactSection() {
  ...
  const socialLinks = [
    { href: "https://www.facebook.com/Elhefnawy.Dewidar.7", icon: FacebookIcon, label: "Facebook" },
    { href: "https://wa.me/+201102118765", icon: Send, label: "WhatsApp" },
    { href: "https://youtube.com/@eng-elhefnawy?si=wzYusXcA0_pup6zj", icon: YoutubeIcon, label: "YouTube" },
    { href: "https://www.tiktok.com/@eng.elhefnawy?_r=1&_t=ZS-97f0DCmRdAa", icon: SparklesIcon, label: "TikTok" },
  ];
