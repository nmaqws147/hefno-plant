        ...
        <div className="hefno-footer-grid">
          ...
          <div>
            ...
            <div className="hefno-footer-social">
              <a href="https://www.facebook.com/Elhefnawy.Dewidar.7" className="hefno-footer-social-btn" aria-label="Facebook" target="_blank" rel="noreferrer">
              ...
              <a href="https://youtube.com/@eng-elhefnawy?si=wzYusXcA0_pup6zj" className="hefno-footer-social-btn" aria-label="YouTube" target="_blank" rel="noreferrer">
              ...
              <a href="https://www.tiktok.com/@eng.elhefnawy?_r=1&_t=ZS-97f0DCmRdAa" className="hefno-footer-social-btn" aria-label="TikTok" target="_blank" rel="noreferrer">
