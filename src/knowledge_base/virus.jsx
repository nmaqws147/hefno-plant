      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-2xl border border-gray-200/60 dark:border-gray-700/50 bg-white dark:bg-gray-800/80 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center gap-5">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg shadow-purple-200/50 dark:shadow-purple-900/30 shrink-0">
              <span className="text-2xl">🧬</span>
            </div>
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-white">الأمراض الفيروسية</h1>
              <p className="mt-1 text-sm text-gray-400 dark:text-gray-500 italic">Viral Diseases</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">الفيروسات النباتية كائنات دقيقة تحت مجهرية، تتكون من حمض نووي محاط بغلاف بروتيني. تنتقل بالحشرات الناقلة والتلامس الميكانيكي.</p>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {paginated.map((d) => (
            <div
              key={d.id}
              onClick={() => openModal(d)}
              className="rounded-2xl border border-gray-200/60 dark:border-gray-700/50 bg-white dark:bg-gray-800/70 p-4 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-pointer border-r-[3px] border-purple-500"
            >
