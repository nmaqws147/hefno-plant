...
const pathogensData = { asco: diseasesData.groups?.find(g => g.group_name_en === 'Ascomycota')?.pathogens || [] };
...
const COLOR = {
  ...
  tabActive: 'bg-orange-50 dark:bg-orange-950/40 text-orange-700 dark:text-orange-400',
  sectionBorder: 'border-orange-200 dark:border-orange-800/50',
  back: 'text-orange-700 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/40 hover:bg-orange-100 dark:hover:bg-orange-950/80',
  enemyBg: 'bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300',
  pagination: 'bg-orange-500 text-white shadow-md shadow-orange-200/50 dark:shadow-orange-900/30',
};
...
const Section = ({ title, icon: Icon, children, list }) => (
  <div className="rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100/60 dark:border-gray-700/30 p-4">
    <h3 className="mb-2 flex items-center gap-1.5 text-xs font-bold text-orange-700 dark:text-orange-300">
      {Icon && <Icon size={12} />}
      {title}
    </h3>
    {list ? (
...
const AscomycotaDiseasesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300" dir="rtl">
      <SEO title="الفطريات الأسكية" description="قائمة أمراض الفطريات الأسكية — البياض الدقيقي، الذبول الفيوزاريومي، واللفحات." url="/knowledge-base/diseases/fungi/asco" />

      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <button
          onClick={() => navigate('/knowledge-base/diseases/fungi')}
          className="mb-5 inline-flex items-center gap-2 rounded-xl bg-orange-50 dark:bg-orange-950/40 px-4 py-2 text-sm font-medium text-orange-700 dark:text-orange-400 transition-colors hover:bg-orange-100 dark:hover:bg-orange-950/80"
        >
        ...
        <div className="mb-6 rounded-2xl border border-gray-200/60 dark:border-gray-700/50 bg-white dark:bg-gray-800/80 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center gap-5">
            <div className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${COLOR.gradient} text-white shadow-lg shadow-orange-200/50 dark:shadow-orange-900/30 shrink-0`}>
              <Bug size={28} />
            </div>
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-white">الفطريات الأسكية</h1>
              <p className={`mt-1 text-sm italic ${COLOR.text}`}>Ascomycota (Sac Fungi)</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">أكبر شعبة في مملكة الفطريات، تضم مسببات أمراض اقتصادية مدمرة مثل البياض الدقيقي والذبول الفيوزاريومي</p>
