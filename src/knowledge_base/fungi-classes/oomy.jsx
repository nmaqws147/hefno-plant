...
const OomycotaDiseasesPage = () => {
  ...
  const [activeTab, setActiveTab] = useState('symptoms'); // tabs: symptoms, management, biology
  ...
  const getTypeText = (type) => {
    if (type.includes('تربة')) return 'مرض تربة';
    if (type.includes('أوراق')) return 'مرض أوراق';
    if (type.includes('جذور')) return 'مرض جذور';
    return type;
  };
      ...
      <div className="oomycota-header special-page-header">
        ...
        <div className="header-content">
          ...
          <div className="header-text">
            <h1>الفطريات البيضية</h1>
            <p className="header-en">Oomycota (Water Molds)</p>
            <p className="header-description">
              الفطريات البيضية ليست فطريات حقيقية بل كائنات تتبع مملكة Stramenopiles، أقرب تطوريًا للطحالب البنية.
              تنتشر في الماء عبر جراثيم سباحة مزدوجة الأسواط، وتضم أخطر مسببات الأمراض كلفحة البطاطس والبياض الزغبي.
            </p>
            <div className="stats-badge">
              <span className="stat-badge">📊 {diseases.length} مرض</span>
              <span className="stat-badge">💧 Phytophthora • Pythium • Plasmopara</span>
              <span className="stat-badge">🌊 جراثيم سباحة</span>
            </div>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="card-content">
              ...
              <div className="cause-tag">
                ...
                <span className="cause-text">{disease.family_ar}</span>
              </div>

              {/* نوع المرض */}
              <div className="disease-type">
                <span className="type-icon">📍</span>
                <span className="type-text">{getTypeText(disease.type)}</span>
              </div>
              ...
              <div className="symptoms-preview">
                ...
                <ul className="symptoms-list">
                  {disease.symptoms.slice(0, 2).map((symptom, idx) => (
                    <li key={idx}>{symptom.substring(0, 60)}...</li>
                  ))}
              ...
              {/* الأعداء الطبيعية */}
              {disease.naturalEnemies && disease.naturalEnemies.length > 0 && (
              ...
              <div className="card-footer">
                <div className="effectiveness">
                  <span>⭐</span> فعالية: {disease.effectiveness || 'عالية'}
                </div>
