...
const pathogensData = { oomy: diseasesData.groups?.find(g => g.group_name_en === 'Oomycota')?.pathogens || [] };
...
const COLOR = {
  ...
  tabActive: 'bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-400',
  back: 'text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-950/80',
  pagination: 'bg-blue-500 text-white shadow-md shadow-blue-200/50 dark:shadow-blue-900/30',
};
...
const OomycotaDiseasesPage = () => {
  ...
  const diseases = pathogensData.oomy || [];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300" dir="rtl">
      <SEO title="الفطريات البيضية" description="قائمة أمراض الفطريات البيضية — لفحات البطاطس، البياض الزغبي، وأعفان الجذور." url="/knowledge-base/diseases/fungi/oomy" />

      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <button
          onClick={() => navigate('/knowledge-base/diseases/fungi')}
          className="mb-5 inline-flex items-center gap-2 rounded-xl bg-blue-50 dark:bg-blue-950/40 px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-400 transition-colors hover:bg-blue-100 dark:hover:bg-blue-950/80"
        >
        ...
        <div className="mb-6 rounded-2xl border border-gray-200/60 dark:border-gray-700/50 bg-white dark:bg-gray-800/80 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center gap-5">
            <div className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${COLOR.gradient} text-white shadow-lg shadow-blue-200/50 dark:shadow-blue-900/30 shrink-0`}>
              <Bug size={28} />
            </div>
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-white">الفطريات البيضية</h1>
              <p className={`mt-1 text-sm italic ${COLOR.text}`}>Oomycota (Water Molds)</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">ليست فطريات حقيقية بل كائنات تتبع مملكة Stramenopiles — تضم أخطر مسببات الأمراض كلفحات البطاطس والبياض الزغبي</p>
              <div className="mt-3 flex flex-wrap gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-xl border border-blue-100/40 dark:border-blue-900/40 bg-blue-50 dark:bg-blue-950/40 px-3 py-1.5 text-xs font-bold text-blue-700 dark:text-blue-400">
        ...
        {totalPages > 1 && (
          <div className="mt-8 flex items-center justify-center gap-2">
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-xl text-xs font-bold transition-all disabled:opacity-30 enabled:hover:bg-blue-50 dark:enabled:hover:bg-blue-900/30 text-gray-600 dark:text-gray-400"
            >
          ...
          >
            ...
            >
              <div className="sticky top-0 z-10 flex items-center gap-4 border-b border-gray-100 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md px-5 py-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 shrink-0 text-xl">
                  <span>🧫</span>
                </div>
                <div className="flex-1 min-w-0">
...
export default OomycotaDiseasesPage;
