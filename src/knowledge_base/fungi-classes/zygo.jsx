    ...
    <div className="oomycota-diseases-page   " dir="rtl">
      ...
      <div className="oomycota-header special-page-header">
        ...
        <div className="header-text">
            <h1>الفطريات الزيجية</h1>
            <p className="header-en">Zygomycota (Bread Molds)</p>
            <p className="header-description">
                فطريات حقيقية تتميز بنموها السريع جداً وميسيليوم غير مقسم بحواجز. 
                تنتشر عبر الهواء والتربة، وتسبب أعفان الثمار الطرية في المخازن وسقوط البادرات، ومن أشهر أجناسها عفن الخبز الأسود.
            </p>
            <div className="stats-badge">
                <span className="stat-badge">📊 {diseases.length} مرض</span>
                <span className="stat-badge">🍞 Rhizopus • Mucor • Choanephora</span>
                <span className="stat-badge">🌑 جراثيم حويصلية سوداء</span>
            </div>
            </div>
        </div>
      </div>
