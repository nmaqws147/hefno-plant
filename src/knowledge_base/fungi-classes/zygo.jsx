...
const pathogensData = { zygo: diseasesData.groups?.find(g => g.group_name_en === 'Zygomycota')?.pathogens || [] };
...
const ZygomycotaDiseasesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300" dir="rtl">
      <SEO title="الفطريات الزيجية" description="قائمة أمراض الفطريات الزيجية — أعفان الثمار المخزنة والعفن الأسود." url="/knowledge-base/diseases/fungi/zygo" />
