...
const COLOR = {
  ...
  tabActive: 'bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-400',
  back: 'text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/40 hover:bg-red-100 dark:hover:bg-red-950/80',
  pagination: 'bg-red-500 text-white shadow-md shadow-red-200/50 dark:shadow-red-900/30',
};
...
const BasidiomycotaDiseasesPage = () => {
  ...
  const diseases = pathogensData.basi || [];
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-2xl border border-gray-200/60 dark:border-gray-700/50 bg-white dark:bg-gray-800/80 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center gap-5">
            <div className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${COLOR.gradient} text-white shadow-lg shadow-red-200/50 dark:shadow-red-900/30 shrink-0`}>
              <Bug size={28} />
            </div>
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-white">الفطريات البازيدية</h1>
              <p className={`mt-1 text-sm italic ${COLOR.text}`}>Basidiomycota (Club Fungi)</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">تضم أخطر مسببات أمراض الحبوب الاستراتيجية كالقمح والذرة — تتميز بدورة حياة معقدة</p>
...
export default BasidiomycotaDiseasesPage;
