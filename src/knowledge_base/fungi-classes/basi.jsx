  ...
  return (
    <div className="oomycota-diseases-page" dir="rtl">
      ...
      <div className="oomycota-header special-page-header">
        ...
        <h1>الفطريات البازيدية</h1>
        <p className="header-en">Basidiomycota (Club Fungi)</p>
        <p className="header-description">
            تضم أخطر مسببات أمراض الحبوب الاستراتيجية كالقمح والذرة. 
            تتميز بدورة حياة معقدة وتكوين أبواغ على حوامل بازيدية، وتشمل فطريات الأصداء، التفحمات، وأعفان الخشب المعمرة في البساتين.
        </p>
        <div className="stats-badge">
            <span className="stat-badge">📊 {diseases.length} مرض</span>
            <span className="stat-badge">🌾 Puccinia • Ustilago • Ganoderma</span>
            <span className="stat-badge">🍄 أبواغ بازيدية وبثرات</span>
        </div>
        </div>
        </div>
      </div>
