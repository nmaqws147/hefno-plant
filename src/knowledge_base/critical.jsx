...
import diseasesData from '../disease-folder/critical.json';

const pathogens = diseasesData.groups?.find(g => g.group_name_en === 'Critical Additions — High Priority Pathogens')?.pathogens || [];
...
const CriticalAdditionsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300" dir="rtl">
      <SEO title="إضافات حرجة — مسببات مرضية ذات أولوية عالية" description="إضافات حرجة لمسببات الأمراض النباتية ذات الأولوية العالية." url="/knowledge-base/diseases/critical-additions" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-2xl border border-gray-200/60 dark:border-gray-700/50 bg-white dark:bg-gray-800/80 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center gap-5">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-orange-600 text-white shadow-lg shadow-red-200/50 dark:shadow-red-900/30 shrink-0">
              <span className="text-2xl">🚨</span>
            </div>
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-white">إضافات حرجة — أولوية عالية</h1>
              <p className="mt-1 text-sm text-gray-400 dark:text-gray-500 italic">Critical Additions — High Priority Pathogens</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">مسببات مرضية جديدة أو متزايدة الأهمية تتطلب مراقبة وإدارة خاصة.</p>
...
export default CriticalAdditionsPage;
